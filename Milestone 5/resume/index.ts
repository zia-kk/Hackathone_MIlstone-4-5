...
let resum_name:any = document.getElementById('resum_name')
resum_name.textContent=My_name

let title_job:any = document.getElementById('title_job')
title_job.textContent=JobTitle

let Age_span:any = document.getElementById('Age_span')
Age_span.textContent=My_age

let Email_span:any = document.getElementById('Email_span')
...
let resum_deg:any = document.getElementById('resum_deg')
resum_deg.textContent=Certificate

let resum_instit:any = document.getElementById('resum_instit')
resum_instit.textContent=University

let resum_city:any = document.getElementById('resum_city')
resum_city.textContent=Education

let resum_year:any = document.getElementById('resum_year')
resum_year.textContent=Pass_year

let res_skill_1:any = document.getElementById('res_skill_1')
res_skill_1.textContent=Experty1

let res_skill_2:any = document.getElementById('res_skill_2')
res_skill_2.textContent=Experty2

let res_skill_3:any = document.getElementById('res_skill_3')
res_skill_3.textContent=Experty3

let resimg:any = document.getElementById('resimg')
resimg.src=picture

let ex1:any = document.getElementById('ex1')
ex1.textContent=Experiance1

let des1:any = document.getElementById('des1')
des1.textContent=Designation1

let exp_time:any = document.getElementById('exp_time')
exp_time.textContent=Ex_Time1

///////////-----------------------------------------------/////

let ex2:any = document.getElementById('ex2')
ex2.textContent=Experiance2

let des2:any = document.getElementById('des2')
des2.textContent=Designation2

let exp_time2:any = document.getElementById('exp_time2')
exp_time2.textContent=Ex_Time2

///////////-----------------------------------------------/////

let ex3:any = document.getElementById('ex3')
ex3.textContent=Experiance3

let des3:any = document.getElementById('des3')
des3.textContent=Designation3

let exp_time3:any = document.getElementById('exp_time3')
...
edit_btn?.addEventListener('click' , ()=>{
 ...
 let userName;
 if(My_name){
    My_name.toLocaleLowerCase().replace(/\s+/g ,"-")
 }else{
      userName= "user"
 }

 let baseurl="http://127.0.0.1:5500/resume/index.html";
 let uniqueurl= `${baseurl}?/${My_name}`
...
const skillsDiv= document.getElementById('skill') as HTMLDivElement|null;
